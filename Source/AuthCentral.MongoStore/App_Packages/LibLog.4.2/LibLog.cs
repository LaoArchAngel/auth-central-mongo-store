...
[assembly: SuppressMessage("Microsoft.Design", "CA1020:AvoidNamespacesWithFewTypes", Scope = "namespace", Target = "Fsw.Enterprise.AuthCentral.MongoStore.Logging")]
[assembly: SuppressMessage("Microsoft.Design", "CA1026:DefaultParametersShouldNotBeUsed", Scope = "member", Target = "Fsw.Enterprise.AuthCentral.MongoStore.Logging.Logger.#Invoke(Fsw.Enterprise.AuthCentral.MongoStore.Logging.LogLevel,System.Func`1<System.String>,System.Exception,System.Object[])")]

// If you copied this file manually, you need to change all "YourRootNameSpace" so not to clash with other libraries
// that use LibLog
#if LIBLOG_PROVIDERS_ONLY
namespace Fsw.Enterprise.AuthCentral.MongoStore.LibLog
#else
namespace Fsw.Enterprise.AuthCentral.MongoStore.Logging
#endif
{
    using System.Collections.Generic;
    using System.Diagnostics.CodeAnalysis;
#if LIBLOG_PROVIDERS_ONLY
    using Fsw.Enterprise.AuthCentral.MongoStore.LibLog.LogProviders;
#else
    using Fsw.Enterprise.AuthCentral.MongoStore.Logging.LogProviders;
#endif
    using System;
#if !LIBLOG_PROVIDERS_ONLY
    ...
    static class LogProvider
    {
        ...
        /// will be disabled.
        /// </summary>
        public const string DisableLoggingEnvironmentVariable = "Fsw.Enterprise.AuthCentral.MongoStore_LIBLOG_DISABLE";
...
#if LIBLOG_PROVIDERS_ONLY
namespace Fsw.Enterprise.AuthCentral.MongoStore.LibLog.LogProviders
#else
namespace Fsw.Enterprise.AuthCentral.MongoStore.Logging.LogProviders
#endif
{
    using System;
    using System.Collections.Generic;
